...
def run_config():
    ...
    gpu = True # Flag that indicates whether to use gpu for training - it is connected with server and jupyter flags, if server is used it
    ...
    if year == "2020":
        ...
        if dataset == 'mini' and server and jupyter==False:  # paths to the datasets
        ...
        elif dataset == 'mini' and server and jupyter:  # paths to the datasets
#             numpy_path = r"/home/jupyter-sale/numpy_new_test/numpy_new_test"
#             numpy_valid_path = r"/home/jupyter-sale/numpy_new_valid/numpy_new_valid"
#             numpy_test_path = r"/home/jupyter-sale/numpy_new_test/numpy_new_test"
            numpy_path = r"C:\Users\daniv\Downloads\numpy_new"
            numpy_valid_path = r"C:\Users\daniv\Downloads\numpy_new_valid"
            numpy_test_path = r"C:\Users\daniv\Downloads\numpy_new_test"
...
def run_config_jupyter(server,gpu,jupyter,load_numpy,use_mask,use_weights,do_testing,count_logs_flag,zscore,binary,freeze_backbone_weights,
    ...
    if year == "2020":
        ...
        if dataset == 'mini' and server and jupyter==False:  # paths to the datasets
            ...
            numpy_valid_path = r"/home/antica/DATASETS/Agriculture_Vision_2021_mini/numpy_new_valid"
            numpy_test_path = r"/home/antica/DATASETS/Agriculture_Vision_2021_mini/numpy_new_test"
        elif dataset == 'mini' and jupyter:  # paths to the datasets
#             numpy_path = r"/home/jupyter-sale/numpy_new_test/numpy_new_test"
#             numpy_valid_path = r"/home/jupyter-sale/numpy_new_valid/numpy_new_valid"
#             numpy_test_path = r"/home/jupyter-sale/numpy_new_test/numpy_new_test"
            numpy_path = r"C:\Users\daniv\Downloads\numpy_new_test"
